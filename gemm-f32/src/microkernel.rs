...
pub mod neon {
    pub mod f32 {
        ...
        microkernel!(["neon"], 2, x4x2, 4, 2);
        microkernel!(["neon"], 2, x4x3, 4, 3);
        microkernel!(["neon"], 2, x4x4, 4, 4, 1, 4);

        microkernel!(["neon"], 2, x5x1, 5, 1);
        microkernel!(["neon"], 2, x5x2, 5, 2);
        microkernel!(["neon"], 2, x5x3, 5, 3);
        microkernel!(["neon"], 2, x5x4, 5, 4, 1, 4);

        microkernel!(["neon"], 2, x6x1, 6, 1);
        microkernel!(["neon"], 2, x6x2, 6, 2);
        microkernel!(["neon"], 2, x6x3, 6, 3);
        microkernel!(["neon"], 2, x6x4, 6, 4, 1, 4);
