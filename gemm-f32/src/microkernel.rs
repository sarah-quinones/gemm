...
pub mod neon {
    pub mod f32 {
        ...
        microkernel!(["neon"], 4, x1x5, 1, 5);
        microkernel!(["neon"], 4, x1x6, 1, 6);
        microkernel!(["neon"], 4, x1x7, 1, 7);
        microkernel!(["neon"], 4, x1x8, 1, 8, 2, 4);

        microkernel!(["neon"], 4, x2x1, 2, 1);
        microkernel!(["neon"], 4, x2x2, 2, 2);
        microkernel!(["neon"], 4, x2x3, 2, 3);
        microkernel!(["neon"], 4, x2x4, 2, 4, 1, 4);
        microkernel!(["neon"], 4, x2x5, 2, 5);
        microkernel!(["neon"], 4, x2x6, 2, 6);
        microkernel!(["neon"], 4, x2x7, 2, 7);
        microkernel!(["neon"], 4, x2x8, 2, 8, 2, 4);

        microkernel!(["neon"], 4, x3x1, 3, 1);
        microkernel!(["neon"], 4, x3x2, 3, 2);
        microkernel!(["neon"], 4, x3x3, 3, 3);
        microkernel!(["neon"], 4, x3x4, 3, 4, 1, 4);
        microkernel!(["neon"], 4, x3x5, 3, 5);
        microkernel!(["neon"], 4, x3x6, 3, 6);
        microkernel!(["neon"], 4, x3x7, 3, 7);
        microkernel!(["neon"], 4, x3x8, 3, 8, 2, 4);

        microkernel!(["neon"], 4, x4x1, 3, 1);
        microkernel!(["neon"], 4, x4x2, 3, 2);
        microkernel!(["neon"], 4, x4x3, 3, 3);
        microkernel!(["neon"], 4, x4x4, 3, 4, 1, 4);
        microkernel!(["neon"], 4, x4x5, 3, 5);
        microkernel!(["neon"], 4, x4x6, 3, 6);
        microkernel!(["neon"], 4, x4x7, 3, 7);
